...
def get_transaction():
    ...
    try:
        ...
        response = {
            ...
            'categoría_Entretenimiento': transaction.get('categoría_entertainment', 0),
            'categoría_Comida y Restaurantes': transaction.get('categoría_food_dining', 0),
            'categoría_Gas y Transporte': transaction.get('categoría_gas_transport', 0),
            'categoría_Supermercado (Online)': transaction.get('categoría_grocery_net', 0),
            'categoría_Supermercado (Tienda Física)': transaction.get('categoría_grocery_pos', 0),
            'categoría_Salud y Fitness': transaction.get('categoría_health_fitness', 0),
            'categoría_Hogar': transaction.get('categoría_home', 0),
            'categoría_Niños y Mascotas': transaction.get('categoría_kids_pets', 0),
            'categoría_Misceláneo (Online)': transaction.get('categoría_misc_net', 0),
            'categoría_Misceláneo (Tienda Física)': transaction.get('categoría_misc_pos', 0),
            'categoría_Cuidado Personal': transaction.get('categoría_personal_care', 0),
            'categoría_Compras (Online)': transaction.get('categoría_shopping_net', 0),
            'categoría_Compras (Tienda Física)': transaction.get('categoría_shopping_pos', 0),
            'categoría_Viajes': transaction.get('categoría_travel', 0),
            'additional_details': {
